...
This Microsoft Teams bot uses the [msbotbuilder-go](https://github.com/carolwu-1206/msbotbuilder-go) library. It shows how to create a simple bot that accepts input from the user and echoes it back.
